...
/** The connection has not yet been established, or it was closed and the user agent is reconnecting. */
EventSource.CONNECTING = ReadyState.CONNECTING;
/** The user agent has an open connection and is dispatching events as it receives them. */
EventSource.OPEN = ReadyState.OPEN;
/** The connection is not open, and the user agent is not trying to reconnect. Either there was a fatal error or the `close()` method was invoked. */
EventSource.CLOSED = ReadyState.CLOSED;
...
export { ReadyState, EventSource, setDefaultReconnectionTime, setReconnectionTimeIncreasingRate, setMaxBufferSize };
//# sourceMappingURL=event-source.mjs.map
